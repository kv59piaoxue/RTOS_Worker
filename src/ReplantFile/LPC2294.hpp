...
********************************************************************************************************/
/* 外部总线控制器 */
#ifndef  __LPC2294_HPP
#define __LPC2294_HPP
...
#define T0CTCR          (*((volatile unsigned long *) 0xE0004070))     /* 为LPC213x增加定时器0计数控制器 */
...
/* 脉宽调制器的特殊寄存器 */
#define PWMIR           (*((volatile unsigned long *) 0xE0014000))     /* 为LPC213x增加定时器1计数控制器 */    
...
/* A/D转换器 */
#define ADCR            (*((volatile unsigned long *) 0xE0034000))      /* Not used for lpc210x*/
#define ADDR            (*((volatile unsigned long *) 0xE0034004))      /* Not used for lpc210x*/
/* for lpc2138 */
...
/* D/A转换器 */
#define DACR            (*((volatile unsigned long *) 0xE006C000))      /* lpc213X only but lpc2131*/
